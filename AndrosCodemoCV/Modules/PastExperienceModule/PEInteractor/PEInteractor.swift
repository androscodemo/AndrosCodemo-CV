...
extension PEInteractor: PEFetcher {
    ...
    func getData() -> [PastExperienceModel] {
        ...
        return [PastExperienceModel(iconName   : "PEUnavailable",
                                    ...
                                    description: "The only iOS developer. I was in charge of the development  and deployment of the applications to TestFlight. Mostly worked with UIKit, Autolayout, CoreBluetooth and Alamofire.".localized),
               PastExperienceModel(iconName   : "PEUnavailable",
                                   ...
                                   description: "In charge of the software development. Developed an iPad application to control a neurostimulation room over Bluetooth.".localized),
               PastExperienceModel(iconName   : "PEUnavailable",
                                   ...
                                   description: "Part of a small development team. Mostly worked with UIKit, Autolayout, Alamofire, CoreData, CoreLocation, AVFoundation.".localized),
               PastExperienceModel(iconName   : "PEBAZ",
                                   title      : "Banco Azteca",
                                   subtitle   : "Senior iOS Developer",
                                   initialDate: formatter.date(from: "2018/10/24")!,
                                   finalDate  : nil,
                                   description: "Part of a big development team. I am in charge of the development and validation of the new application. Also I help the team to get used to the programming language Swift.".localized)]
    }
